...
Route::middleware('auth')->group(function(){
    ...
    Route::get('debitur/{id}/backSlik',[DebiturController::class,'backSlik']);
    ...
    Route::post('fasilitas/media',[FasilitasController::class, 'storeMedia'])->name('fasilitas.storeMedia');
    ...
    Route::get('fasilitas/{id}/rejectmitra',[FasilitasController::class,'rejectmitra'])->name('fasilitas.rejectmitra');
    ...
    Route::put('fasilitas/{id}/revisiPlafond',[FasilitasController::class,'revisiPlafond'])->name('fasilitas.revisiPlafond');
