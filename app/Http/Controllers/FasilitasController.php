...
class FasilitasController extends Controller
{
            ...
            return DataTables::of($fasilitas)
                ...
                ->editColumn('status', function ($data) {
                    ...
                    if (Gate::allows('read status')) {
                        ...
                        $download = '<span class="badge badge-info">Approve Fasilitas Mitra</span>';

                        $download .= ' <a href="fasilitas/' . $data->id . '/download" data-toggle="tooltip" data-id="' . $data->id . '"
                        class="edit btn btn-primary btn-sm ">Download Berkas</a>';
    ...
    public function store(FasilitasRequest $request)
    {
        ...
        //modifikasi tanpa otorisasi cabang
    ...
    public function approve(Fasilitas $fasilitas, $id, Request $request)
    {
        ...
        $plafondRekomen = $fasilitas->PlafondRekomen;

        if ($plafondRekomen == null) {
            $fasilitas->PlafondRekomen = $plafond;
            $fasilitas->status = '4';
            $debitur->sttsPengajuan = '7';
            $fasilitas->save();
        } else {
