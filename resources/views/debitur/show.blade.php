            ...
            <div class="card-columns">
                @foreach ($image as $foto)
                    <div class="card m-b-30">
                        <img class="card-img-top img-fluid" src="{{ $foto->getUrl() }}" alt="Card image cap">
                    </div>
                @endforeach
                <div class="card m-b-30">
            ...
            <div class="card m-b-30">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" type="text" value="{{ $debitur->name }}" id="example-text-input">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row has-danger">
                        ...
                        <div class="col-sm-10">
                            <input type="email" class="form-control form-control-danger" id="inputHorizontalDnger"
                                placeholder="name@example.com">
