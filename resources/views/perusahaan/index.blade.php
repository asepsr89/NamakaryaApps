    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-title-box">
                <h4 class="page-title">Manage Perusahaan</h4>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-lg">
            <div class="card bg-white m-b-30">
                <div class="card-body new-user">
                    <h5 class="header-title mb-4 mt-0">Data Perusahaan</h5>
...
@push('scripts')
    ...
    <script>
            ...
            $('#formAction').on('submit', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        window.LaravelDataTables["perusahaandatatables-table"].ajax.reload()
                        $('#modalAction').find('.modal-dialog').html(response)
        ...
        $('#perusahaandatatables-table').on('click', '.action', function() {
            let data = $(this).data()
            let id = data.id
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            ...
                            success: function(response) {
                                window.LaravelDataTables["perusahaandatatables-table"].ajax
                                    .reload()
                                Swal.fire(
                                    'Deleted!',
                                    response.message,
