    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-title-box">
                <h4 class="page-title">Form Revisi Fasilitas</h4>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
            <form method="POST" action="{{ route('fasilitas.updatemitra', $data->id) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="card m-b-30">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <textarea id="note" name="note" value="{{ $data->notemitra }}" placeholder="Enter Details" class="uneditable"
                                    readonly>{{ $data->notemitra }}</textarea>
                            </div>
                        </div>
                        <div class="form-group row">
...
@push('scripts')
    ...
    <script>
        ...
        Dropzone.options.documentDropzone = {
            url: '{{ route('fasilitas.storeMedia') }}',
            maxFilesize: 10, // MB
            addRemoveLinks: true,
            headers: {
