    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-title-box">
                <h4 class="page-title">Manage Mita</h4>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-lg">
            <div class="card bg-white m-b-30">
                <div class="card-body new-user">
                    <h5 class="header-title mb-4 mt-0">Data Mitra</h5>
                    @can('create menu')
...
@push('scripts')
    ...
    <script>
            ...
            $('#formAction').on('submit', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        window.LaravelDataTables["mitra-table"].ajax.reload()
                        $('#modalAction').find('.modal-dialog').html(response)
        ...
        $('#mitra-table').on('click', '.action', function() {
            let data = $(this).data()
            let id = data.id
